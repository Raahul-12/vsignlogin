...
export class AppComponent implements OnInit, OnDestroy {
    ...
    constructor(
      ...
      //vsign icons
      mdIconRegistry.addSvgIcon('notification', sanitizer.bypassSecurityTrustResourceUrl('/assets/vsignsvgs/notification.svg'));
      mdIconRegistry.addSvgIcon('document', sanitizer.bypassSecurityTrustResourceUrl('/assets/vsignsvgs/document.svg'));
      mdIconRegistry.addSvgIcon('repost', sanitizer.bypassSecurityTrustResourceUrl('/assets/vsignsvgs/repost.svg'));
      mdIconRegistry.addSvgIcon('classification', sanitizer.bypassSecurityTrustResourceUrl('/assets/vsignsvgs/classification.svg'));
      mdIconRegistry.addSvgIcon('signed', sanitizer.bypassSecurityTrustResourceUrl('/assets/vsignsvgs/signed.svg'));
      mdIconRegistry.addSvgIcon('template', sanitizer.bypassSecurityTrustResourceUrl('/assets/vsignsvgs/template.svg'));
      mdIconRegistry.addSvgIcon('connections', sanitizer.bypassSecurityTrustResourceUrl('/assets/vsignsvgs/connections.svg'));
      mdIconRegistry.addSvgIcon('in-sign', sanitizer.bypassSecurityTrustResourceUrl('/assets/vsignsvgs/in-sign.svg'));
